$(document).ready(function() {
  ...
  function CargarAnuncio() {
    ...
    $('#registro').submit(e => {
      ...
      const url = 'RegistrarAdministrador.php';
  ...
  $('#inicioAcount').submit(e => {
    e.preventDefault();
    
    let correo= $('#correoIngresoinicioAcount').val();
    let contra = $('#passIngresoinicioAcount').val();
